                       ...
                       const string& label_file)
{
  ...
  //CHECK_EQ(net_->num_outputs(), 1) << "Network should have exactly one output.";
	cout << "number of network outputs: " << net_ ->num_outputs() << endl;
	
  Blob<float>* input_layer = net_->input_blobs()[0];
  
  cout << "net input_layer width: " << input_layer->width() << endl;
  cout << "net input_layer height: " << input_layer->height() << endl;
  
  num_channels_ = input_layer->channels();
  cout << "net input layer channels: " << num_channels_ << endl;
